...
import com.basiclab.iot.device.factory.RemoteDeviceOpenAnyFallbackFactory;
 ...
 * @author EasyAIoT
 */
@FeignClient(contextId = "remoteDeviceOpenService", value = ServiceNameConstants.IOT_DEVICE, fallbackFactory = RemoteDeviceOpenAnyFallbackFactory.class)
