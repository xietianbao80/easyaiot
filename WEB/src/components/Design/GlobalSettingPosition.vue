<template>
  <setting-item-box v-if="targetData" name="位置">
    <setting-item :name="`偏移 X：${targetData.left || 0}px`">
      <a-input-number v-model:value="targetData.left" size="small" step="10"></a-input-number>
    </setting-item>
    <setting-item :name="`偏移 Y：${targetData.top || 0}px`">
      <a-input-number v-model:value="targetData.top" size="small" step="10"></a-input-number>
    </setting-item>
  </setting-item-box>
</template>
