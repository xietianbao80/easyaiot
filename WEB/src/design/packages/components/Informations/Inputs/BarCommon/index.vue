...
import {useCanvasInitOptions} from '@/hooks/design/useCanvasInitOptions.hook'
import {use} from 'echarts/core'
import {CanvasRenderer} from 'echarts/renderers'
import {BarChart} from 'echarts/charts'
import config, {includes, seriesItem} from './config'
import {mergeTheme} from '@/design/packages/public/chart'
import {useChartDataFetch} from '@/hooks/design'
